...
ENRICH: Questions that require current events, recent news, real-time data, today's date/time, or information after a knowledge cutoff date. ANY question using words like "today", "tonight", "tomorrow", "yesterday", "right now", "current", "latest", "recent", "this week", "this year", "this month", "next week", or referencing a specific future/present date. Also applies to questions about whether a specific place is open/closed, business hours, school schedules, event times, or anything that depends on up-to-date real-world status.
Examples: "What happened in the news today?", "What is the current price of Bitcoin?", "Who won the latest election?", "What are the newest features in Python 3.14?", "What is today's date?", "What day is it?", "Is the library open tomorrow?", "What's the schedule for next week?"
